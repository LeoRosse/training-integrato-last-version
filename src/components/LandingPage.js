      ...
      <Modal show={this.state.showModal} modalClosed={this.modalCancelHandler}>
        <div className="popup__content">
          <div className="popup__left">
            <img
              src="images/sport_popup-web.jpg"
              alt="Sport"
          ...
          <div className="popup__right">
            ...
            <div className="paragraph">
              <ul className="paragraph__list">
                ...
                <li className="paragraph__item">
                  Suggerimenti di tecniche da praticare a casa
                </li>
                <li className="paragraph__item">
                  Indicazione per una adeguata attività fisica
                </li>
              </ul>
            </div>
            <a
        ...
        <footer className="footer">
          ...
          <div className="row">
            <div className="col-1-of-2">
              <div className="footer__logo--box">
                <a
                  href="http://www.facebook.com/trainingintegrato.it"
                  target="blank"
                >
                ...
                <a
                  href="https://www.instagram.com/trainingintegrato/"
                  target="blank"
                >
            ...
            <div className="col-1-of-2">
              ...
              <p className="footer__copyright">
                Built by{" "}
                <a
                  href="https://www.facebook.com/l.rosseti"
                  className="footer__link"
                >
                  {" "}
                  Leonardo Rosseti
              ...
              <p className="footer__copyright footer__copyright--noborder">
                Copyright
                <a
                  href="http://www.trainingintegrato.com/"
                  className="footer__link"
                >
